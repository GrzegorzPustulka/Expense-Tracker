...
class InsertFrame(customtkinter.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        self.count_label.grid(row=4, column=0, padx=10, pady=10)
        self.count_entry = customtkinter.CTkEntry(self,
                                                  width=120,
                                                  height=25,
                                                  border_width=2,
                                                  corner_radius=10)
        self.count_entry.grid(row=4, column=1, padx=10, pady=10)
    ...
    def add_click(self):
        ...
        info_label.grid(row=6, column=0, padx=10, pady=10)

        total_price_label = customtkinter.CTkLabel(self, text=f'Total price: {total_price}')
        total_price_label.grid(row=7, column=0, padx=10, pady=10)
